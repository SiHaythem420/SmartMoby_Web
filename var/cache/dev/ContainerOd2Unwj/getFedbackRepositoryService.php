 ...
 */
class getFedbackRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FedbackRepository' shared autowired service.
     *
     * @return \App\Repository\FedbackRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FedbackRepository.php';

        return $container->privates['App\\Repository\\FedbackRepository'] = new \App\Repository\FedbackRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
