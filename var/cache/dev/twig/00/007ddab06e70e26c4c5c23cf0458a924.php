...
class __TwigTemplate_02011b58a9aa606f2aae0d3078444358 extends Template
{
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_categorie_delete', {'id': categorie.id}) }}\" 
      onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cette catégorie ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ categorie.id) }}\">
    <button class=\"btn btn-sm btn-danger\">
        <i class=\"fas fa-trash\"></i>
    </button>
</form>", "categorie/_delete_form.html.twig", "C:\\Users\\user\\Desktop\\symfonyfareszakrawicrud\\hamhama\\templates\\categorie\\_delete_form.html.twig");
    }
}
