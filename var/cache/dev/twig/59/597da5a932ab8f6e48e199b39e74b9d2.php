...
class __TwigTemplate_ca534b14dcee8a51399e19d56edd40ed extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("back_base.html.twig", "categorie/show.html.twig", 1);
            ...
            <table class=\"table\">
                <tbody>
                    <tr>
                        ...
                        <td>";
        // line 15
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15), "html", null, true);
        yield "</td>
                    </tr>
                    <tr>
                        <th>Nom</th>
                        <td>";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 19, $this->source); })()), "nom", [], "any", false, false, false, 19), "html", null, true);
        yield "</td>
                    </tr>
                    <tr>
                        <th>Description</th>
                        <td>";
        // line 23
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 23, $this->source); })()), "description", [], "any", false, false, false, 23), "html", null, true);
        yield "</td>
                    </tr>
                </tbody>
            </table>
...
";
    ...
    {
        return array (  143 => 34,  137 => 31,  126 => 23,  119 => 19,  112 => 15,  101 => 6,  88 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Catégorie #{{ categorie.id }}{% endblock %}
...
<div class=\"container mt-4\">
    ...
    <div class=\"mt-3\">
        ...
        <a href=\"{{ path('app_categorie_edit', {'id': categorie.id}) }}\" class=\"btn btn-primary\">
            <i class=\"fas fa-edit\"></i> Modifier
        </a>
    </div>
</div>
{% endblock %}", "categorie/show.html.twig", "C:\\Users\\admin\\Desktop\\hamhama\\templates\\categorie\\show.html.twig");
    }
}
