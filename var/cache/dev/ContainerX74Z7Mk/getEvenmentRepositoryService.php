 ...
 */
class getEvenmentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EvenmentRepository' shared autowired service.
     *
     * @return \App\Repository\EvenmentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EvenmentRepository.php';

        return $container->privates['App\\Repository\\EvenmentRepository'] = new \App\Repository\EvenmentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
