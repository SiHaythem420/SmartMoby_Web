 ...
 */
class getConducteurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConducteurRepository' shared autowired service.
     *
     * @return \App\Repository\ConducteurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConducteurRepository.php';

        return $container->privates['App\\Repository\\ConducteurRepository'] = new \App\Repository\ConducteurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
